## Chương 10: Sử Dụng SafeMath

Chúng ta đã gần hoàn thành Oracle phi tập trung! Trước khi kết thúc, hãy làm các bước sau:

1. **Xóa khóa `id` khỏi `requestIdToResponse`:**
2. **Cập nhật hàm `setLatestEthPrice`:**
3. **Thay đổi tham số đầu tiên của `SetLatestEthPriceEvent`:**
